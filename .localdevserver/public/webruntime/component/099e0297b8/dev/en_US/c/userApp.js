Webruntime.moduleRegistry.define('c/userApp', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$x($api, $cmp, $slotset, $ctx) {
      ...
      }, [api_text("Company Info")]), api_custom_element("lightning-output-field", _lightningOutputField, {
      ...
      }, [api_text("Billing Info")]), api_custom_element("lightning-output-field", _lightningOutputField, {
      ...
      }, [api_text("Employee Info")])])])])])]), api_element("div", {
        key: 11
      }, [api_slot("", {
        key: 12
      }, [], $slotset)])])];
